...
cd ..
cd system/sepolicy
git apply -v ../../device/doogee/X5/patches/0003-Revert-back-to-policy-version-29.patch
cd ../..
cd frameworks/av
git apply -v ../../device/doogee/X5/patches/0006-fix-access-wvm-to-ReadOptions.patch
...
git apply -v ../../device/doogee/X5/patches/0009-add-mtk-color-format-support.patch
git apply -v ../../device/doogee/X5/patches/0013-fix_video_autoscaling.patch
cd ../..
cd system/netd
